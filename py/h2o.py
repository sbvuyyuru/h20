...
class H2O(object):
    ...
    rest_version = 99 # Read from configuration file
...
#    @profile
    ...
    def jobs(self, job_key=None, timeoutSecs=10, **kwargs):
        ...
        result = self.__do_json_request('/'+str(self.rest_version)+'/Jobs', timeout=timeoutSecs, params=params_dict)
        return result
    ...
    def poll_job(self, job_key, timeoutSecs=10, retryDelaySecs=0.5, **kwargs):
        ...
        while True:
            ...
            result = self.__do_json_request('/'+str(self.rest_version)+'/Jobs/' + job_key, timeout=timeoutSecs, params=params_dict)
    ...
    Create a Frame.
    '''
    def create_frame(self, raiseIfNon200=True, timeoutSecs=180, **kwargs):
    ...
    def interaction(self, timeoutSecs=180, **kwargs):
        a = self.__do_json_request('/'+str(self.rest_version)+'/Interaction', cmd="post",
                                   timeout=timeoutSecs,
                                   postData=kwargs
        )
    ...
    def import_files(self, path, timeoutSecs=180):
        a = self.__do_json_request('/'+str(self.rest_version)+'/ImportFiles',
            timeout=timeoutSecs,
            params={"path": path}
        )
    ...
    def parse(self, key, dest_key=None,
        ...
        setup_result = self.__do_json_request(jsonRequest="/" + str(self.rest_version) + "/ParseSetup", cmd='post', timeout=timeoutSecs, postData=parse_setup_params)
        ...
        parse_result = self.__do_json_request(jsonRequest="/"+str(self.rest_version)+"/Parse", cmd='post', timeout=timeoutSecs, postData=parse_params, **kwargs)
    ...
    def frames_negetive(self, key=None, timeoutSecs=10, **kwargs):
        if key:
            result = self.__do_json_request('/'+str(self.rest_version)+'/Frames/' + key, timeout=timeoutSecs, params=kwargs, raiseIfNon200=False)
        else:
            result = self.__do_json_request('/'+str(self.rest_version)+'/Frames', timeout=timeoutSecs, params=kwargs, raiseIfNon200=False)
    ...
    def columns(self, key, timeoutSecs=10, **kwargs):
        ...
        return result
    '''
    Exports for a singel Frame in the h2o Cluster.
    '''
    ...
    '''
    Return a list of domains for a column in a single Frame in the h2o cluster.
    '''
    def domain(self, key, column, raiseIfNon200=False,timeoutSecs=10, **kwargs):

        result = self.__do_json_request('/'+str(self.rest_version)+'/Frames/' + key + '/columns/' + column +'/domain',
                        timeout=timeoutSecs, raiseIfNon200=raiseIfNon200, params=kwargs)
    ...
    def column(self, key, column, timeoutSecs=10, **kwargs):
        ...
        result = self.__do_json_request('/'+str(self.rest_version)+'/Frames/' + key + '/columns/' + column, timeout=timeoutSecs, params=params_dict)
        return result
    ...
    def summary(self, key, column, timeoutSecs=10, **kwargs):
        ...
        result = self.__do_json_request('/'+str(self.rest_version)+'/Frames/' + key + '/columns/' + column + '/summary', timeout=timeoutSecs, params=params_dict)
        return result
    ...
    def delete_frame(self, key, ignoreMissingKey=True, timeoutSecs=60, **kwargs):
        ...
        result = self.__do_json_request('/'+str(self.rest_version)+'/Frames/' + key, cmd='delete', timeout=timeoutSecs)
    ...
    def delete_frames(self, timeoutSecs=60, **kwargs):
        parameters = { }
        result = self.__do_json_request('/'+str(self.rest_version)+'/Frames', cmd='delete', timeout=timeoutSecs)
    ...
    def build_model(self, algo, training_frame, parameters, model_id = None, timeoutSecs=60, asynchronous=False, **kwargs):
        ...
        result = self.__do_json_request('/'+str(self.rest_version)+'/ModelBuilders/' + algo, cmd='post', timeout=timeoutSecs, postData=parameters, raiseIfNon200=False)  # NOTE: DO NOT die if validation errors
    ...
    def compute_model_metrics(self, model, frame, timeoutSecs=60, **kwargs):
        ...
        result = self.__do_json_request('/'+str(self.rest_version)+'/ModelMetrics/models/' + model + '/frames/' + frame, cmd='post', timeout=timeoutSecs)
    ...
    def predict(self, model, frame, predictions_frame = None, timeoutSecs=60, **kwargs):
        ...
        result = self.__do_json_request('/'+str(self.rest_version)+'/Predictions/models/' + model + '/frames/' + frame, cmd='post', postData=postData, timeout=timeoutSecs)
        return result
    ...
    def model_metrics(self, model=None, frame=None, timeoutSecs=60, **kwargs):
        if model is None and frame is None:
            result = self.__do_json_request('/'+str(self.rest_version)+'/ModelMetrics', cmd='get', timeout=timeoutSecs)
        elif model is not None and frame is not None:
            result = self.__do_json_request('/'+str(self.rest_version)+'/ModelMetrics/models/' + model + '/frames/' + frame, cmd='get', timeout=timeoutSecs)
        else:
    ...
    def delete_model_metrics(self, model, frame, timeoutSecs=60, **kwargs):
        ...
        result = self.__do_json_request('/'+str(self.rest_version)+'/ModelMetrics/models/' + model + '/frames/' + frame, cmd='delete', timeout=timeoutSecs)
    ...
    def delete_model(self, key, ignoreMissingKey=True, timeoutSecs=60, **kwargs):
        ...
        result = self.__do_json_request('/'+str(self.rest_version)+'/Models/' + key, cmd='delete', timeout=timeoutSecs)
    ...
    def delete_models(self, timeoutSecs=60, **kwargs):
        parameters = { }
        result = self.__do_json_request('/'+str(self.rest_version)+'/Models', cmd='delete', timeout=timeoutSecs)
    ...
    def endpoints(self, timeoutSecs=60, **kwargs):
        parameters = { }
        result = self.__do_json_request('/'+str(self.rest_version)+'/Metadata/endpoints', cmd='get', timeout=timeoutSecs)
    ...
    def endpoint_by_number(self, num, timeoutSecs=60, **kwargs):
        parameters = { }
        result = self.__do_json_request('/'+str(self.rest_version)+'/Metadata/endpoints/' + str(num), cmd='get', timeout=timeoutSecs)
    ...
    def schemas(self, timeoutSecs=60, **kwargs):
        parameters = { }
        result = self.__do_json_request('/'+str(self.rest_version)+'/Metadata/schemas', cmd='get', timeout=timeoutSecs)
    ...
    def schema(self, schemaname, timeoutSecs=60, **kwargs):
        parameters = { }
        result = self.__do_json_request('/'+str(self.rest_version)+'/Metadata/schemas/' + schemaname, cmd='get', timeout=timeoutSecs)
