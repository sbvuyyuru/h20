...
def validate_412_statusCode(response):
    assert response['http_status'] == 412, "FAIL Staus code wrong parameter is not Correct"

def validate_412_InfoMessage(response, expMsg):
    assert response['msg'] == expMsg, "FAIL Information message is not as expected for wrong parameter"
